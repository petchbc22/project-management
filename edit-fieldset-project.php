...
<?php
    ...
    // get data to form edit
    $SQL_pj_field = "SELECT * FROM project WHERE pj_id = '$ss_pj_id'";
    $SQL_pj_field_qr = mysqli_query($conn,$SQL_pj_field);
    $SQL_pj_field_rs = mysqli_fetch_array($SQL_pj_field_qr,MYSQLI_ASSOC);

    $get_pj_process_title       = $SQL_pj_field_rs["pj_process_title"];
    $get_pj_customner           = $SQL_pj_field_rs["pj_customner"];
    $get_pj_process_start       = $SQL_pj_field_rs["pj_process_start"];
    $get_pj_process_deadline    = $SQL_pj_field_rs["pj_process_deadline"];
?>
...
<body id="create-project">
                            ...
                            <fieldset id="info" class="">
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control bd-rd30" id="pj_name" name="pj_name"
                                        placeholder="Name Project" value="<?php echo $get_pj_process_title; ?>">
                                </div>
                                <div class="form-group text-left">
                                    <label class="pt-2">Name Customer</label>
                                    <input type="text" class="form-control bd-rd30" id="pj_customer" name="pj_customer"
                                        placeholder="Name Customer" value="<?php echo $get_pj_customner; ?>">
                                </div>
                                <div class="form-group text-left">
                                    <label class="pt-2">Start Date</label>
                                    <input type="text" autocomplete="off"
                                        class="dateStart form-control form-control-sm w-100 bd-rd30 h-38"
                                        id="pj_process_start" name="pj_process_start" placeholder="Start date" value="<?php echo $get_pj_process_start; ?>">
                                </div>
                                <div class="form-group text-left">
                                    <label class="pt-2">Due Date</label>
                                    <input type="text" autocomplete="off"
                                        class="dateEnd form-control form-control-sm w-100 bd-rd30 h-38"
                                        id="pj_duedate" name="pj_duedate" placeholder="Due date" value="<?php echo $get_pj_process_deadline; ?>">
                                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- pre prodution -->
                                        <input type="hidden" id="ss_pj_id" value="<?php echo $ss_pj_id; ?>" name="ss_pj_id">
    ...
    $('#save-ajax').click(function() {
        ...
        $.ajax({
            url: "service/edit-infieldset-project.php",
            method: "POST",
            data: {
                ss_pj_id:ss_pj_id,
                pj_name: pj_name,
